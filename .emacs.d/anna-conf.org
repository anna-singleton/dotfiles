...
**** Unbreak Projectile
#+begin_src emacs-lisp
  (add-hook 'java-mode-hook (define-key projectile-mode-map (kbd "C-c p") 'projectile-command-map))
#+end_src>
for some reason, java mode unbinds projectile's command map, this binds it back
